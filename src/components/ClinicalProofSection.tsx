...
export const ClinicalProofSection: React.FC = () => {
  ...
  return (
    <section id="clinical-proof" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto w-full">
      <div className="bg-[#141c2e]/70 backdrop-blur-2xl border border-[#7dd3fc]/20 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl relative overflow-hidden">
        {/* Glow ambient */}
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#7dd3fc]/10 rounded-full blur-3xl pointer-events-none"></div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          {/* Graph Explanation Text (5 cols) */}
          <div className="lg:col-span-5 flex flex-col space-y-5 text-right">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-headline font-black text-white leading-snug">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-[#1a2438]/85 border border-[#7dd3fc]/25 shadow-sm">
                <div className="w-10 h-10 rounded-xl bg-[#7dd3fc]/20 text-[#7dd3fc] flex items-center justify-center font-bold text-sm shrink-0">
                  <TrendingDown className="w-5 h-5 text-[#7dd3fc]" />
                </div>
              ...
              <div className="flex items-center gap-3 p-3.5 rounded-2xl bg-[#1a2438]/85 border border-[#ff6b6b]/20 shadow-sm">
                <div className="w-10 h-10 rounded-xl bg-[#3d1414]/80 text-[#ff6b6b] flex items-center justify-center font-bold text-sm shrink-0">
            ...
            <div className="pt-2 flex items-center gap-4">
              <a
                href="#order-form"
                className="text-[#7dd3fc] hover:text-[#c8eaff] font-bold text-sm inline-flex items-center gap-2 group"
              >
              ...
              <button
                ...
                className="text-xs text-[#a0b4c4] hover:text-white underline underline-offset-4"
              >
          ...
          <div className="lg:col-span-7 flex flex-col items-center">
            {selectedView === 'chart' ? (
              ...
              <div className="w-full rounded-2xl bg-[#0a0e1a]/90 border border-[#7dd3fc]/25 p-5 shadow-2xl text-right">
                <h4 className="text-base font-bold text-white mb-4 flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#7dd3fc]" />
                  مقارنة النتائج السريرية بعد 15 دقيقة
                </h4>
                <div className="space-y-3 text-xs sm:text-sm">
                  <div className="p-3 rounded-xl bg-[#141c2e] border border-white/10 flex justify-between items-center">
            ...
            <p className="text-[11px] text-[#a0b4c4]/80 mt-3 text-center">
